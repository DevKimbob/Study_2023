...
int main(int argc, char* argv[]){
	...
	const char      *s_ipaddr = "192.168.253.154";   
	...
	fgets (hello, 80, stdin);       /* Load encryption & hashing algorithms for the SSL program */  
...
//	meth = SSLv3_method();  /* Create an SSL_CTX structure */   
	...
	SSL_set_fd(ssl, sock);  /* Perform SSL Handshake on the SSL client */  
	err = SSL_connect(ssl);     
	RETURN_SSL(err);      
